# 2026-09-14 자판기 후기 3편(대구·남양주·이천)을 목록 맨 앞에 추가 + 사이트맵. 라이브 형식 보존, 카운트 정규식.
$ErrorActionPreference='Stop'
$repo="$env:USERPROFILE\Desktop\yoon"
$enc=New-Object System.Text.UTF8Encoding($false)

$new=@(
 @{f='blog/2026-09-14-icheon-vending.html'; img='photos/vend-yongin.jpg'; alt='이천 물류센터 휴게실 직원용 무인자판기 여러 대 설치 - H포스'; label='이천 자판기'; h='이천 무인자판기 설치 완료 — 물류센터 휴게실 직원용 자판기'; p='경기 이천 마장면 물류센터 휴게실에 직원용 음료·스넥·간식 무인자판기 여러 대를 설치했습니다. 셀프 결제·앱 원격관리로 24시간 무인 운영, 야간·교대 근무 많은 물류센터라 고정 수요가 확실한 자리.'}
 @{f='blog/2026-09-14-namyangju-vending.html'; img='photos/vend-songdo.jpg'; alt='남양주 다산신도시 아파트 단지 상가 무인자판기 설치 - H포스'; label='남양주 자판기'; h='남양주 무인자판기 설치 완료 — 다산신도시 아파트 상가 무인점포'; p='경기 남양주 다산신도시 아파트 단지 상가에 음료·스넥·냉동 멀티 무인자판기를 설치했습니다. 셀프 결제·앱 원격관리로 24시간 무인 운영, 세대 수 많은 신도시 단지라 야간·주말 수요가 확실.'}
 @{f='blog/2026-09-14-daegu-vending.html'; img='photos/vend-nowon.jpg'; alt='대구 수성구 오피스 건물 직원용 음료·간식 무인자판기 설치 - H포스'; label='대구 자판기'; h='대구 무인자판기 설치 완료 — 수성구 오피스 건물 직원용 자판기'; p='대구 수성구 범어동 오피스 건물 휴게 공간에 직원용 음료·커피·간식 무인자판기를 설치했습니다. 셀프 결제·앱 원격관리로 24시간 무인 운영, 상주 인원 많은 오피스라 고정 수요가 확실한 자리.'}
)
$newCards=@()
foreach($n in $new){
  $newCards += @"
<a class="post-card" href="$($n.f)">
      ...
      <div class="pc-body">
        <div class="pc-date">2026.09.14 · $($n.label)</div>
        <h2>$($n.h)</h2>
        <p>$($n.p)</p>
      </div>
    </a>
...
foreach($n in $new){
  if($sc -notmatch [regex]::Escape($n.f)){
    $line='  <url><loc>https://hpos.co.kr/'+$n.f+'</loc><lastmod>2026-09-14</lastmod><changefreq>monthly</changefreq><priority>0.7</priority></url>'
